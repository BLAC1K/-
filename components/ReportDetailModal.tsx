                ...
                <div className="hidden print:block border-b-2 border-black mb-6 pb-4">
                    <div className="flex justify-between items-start">
                        <div className="text-right space-y-1">
                            <h2 className="text-xl font-bold">دائرة/جهة العمل</h2>
                            <p className="font-semibold text-lg">الشعبة: الإدارة / شعبة التمكين</p>
                            <p className="font-medium">الوحدة: {user.unit || 'غير محدد'}</p>
