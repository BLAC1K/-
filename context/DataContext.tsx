...
const MOCK_USERS: User[] = [
    { id: '1', fullName: 'أحمد عبدالله محمد', badgeNumber: 'MGR-001', phone: '01', role: Role.MANAGER, password: 'admin', jobTitle: 'مدير الشعبة', profilePictureUrl: 'https://i.pravatar.cc/150?u=1' },
];
